...
namespace FFXI
{
ClassicThirdPersonInputComponent::ClassicThirdPersonInputComponent(
...
lotus::Task<> ClassicThirdPersonInputComponent::tick(lotus::time_point time, lotus::duration delta)
{
    ...
    if (moving.x != 0 || moving.z != 0)
    {
        ...
        auto camera_quat =
            glm::angleAxis(glm::orientedAngle(glm::normalize(glm::vec2{camera_dir.x, camera_dir.z}), glm::vec2{1, 0}),
                           glm::vec3{0, -1, 0});
