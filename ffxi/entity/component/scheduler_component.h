...
class SchedulerComponent
    : public lotus::Component::Component<SchedulerComponent,
                                         lotus::Component::Before<lotus::Component::AnimationComponent>>
{
public:
    explicit SchedulerComponent(lotus::Entity*, lotus::Engine* engine, ActorSkeletonComponent& actor,
                                FFXI::Scheduler* scheduler, SchedulerResources* resources,
