...
{
public:
    using InitComponents =
        std::tuple<lotus::Component::AnimationComponent*, lotus::Component::RenderBaseComponent*,
                   lotus::Component::DeformedMeshComponent*, lotus::Component::DeformableRasterComponent*,
                   lotus::Component::DeformableRaytraceComponent*, FFXI::ActorComponent*,
                   FFXI::ActorSkeletonComponent*>;
    static lotus::Task<std::pair<std::shared_ptr<lotus::Entity>, InitComponents>>
    Init(lotus::Engine* engine, lotus::Scene* scene, uint16_t modelid);
    using InitPCComponents =
        std::tuple<lotus::Component::AnimationComponent*, lotus::Component::RenderBaseComponent*,
                   lotus::Component::DeformedMeshComponent*, lotus::Component::DeformableRasterComponent*,
                   lotus::Component::DeformableRaytraceComponent*, FFXI::ActorComponent*,
                   FFXI::ActorSkeletonComponent*>;
    static lotus::Task<std::pair<std::shared_ptr<lotus::Entity>, InitPCComponents>>
    Init(lotus::Engine* engine, lotus::Scene* scene, FFXI::ActorSkeletonComponent::LookData look);
    static size_t GetPCModelDatID(uint16_t modelid, uint8_t race);

protected:
    static lotus::WorkerTask<InitComponents> Load(std::shared_ptr<lotus::Entity> entity, lotus::Engine* engine,
                                                  lotus::Scene* scene, std::shared_ptr<const FFXI::ActorSkeletonStatic>,
