...
namespace FFXI
{
    ...
    public:
        ...
        std::tuple<const std::unordered_map<std::string, std::unique_ptr<lotus::Animation>>&, const std::unordered_map<std::string, std::unique_ptr<lotus::Animation>>&> getBattleAnimationsDualWield(size_t index) const;
