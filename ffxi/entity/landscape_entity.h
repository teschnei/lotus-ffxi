...
public:
    ...
    Init(lotus::Engine* engine, lotus::Scene* scene, size_t zoneid);
    // FFXI::QuadTree quadtree{glm::vec3{}, glm::vec3{}};
protected:
    static lotus::WorkerTask<> Load(std::shared_ptr<lotus::Entity> entity, lotus::Engine* engine, size_t zoneid,
                                    lotus::Scene* scene);
